...
public class PersonListAdapter extends Fragment {
    ...
    public static PersonListAdapter newInstance(String param1) {
        PersonListAdapter fragment = new PersonListAdapter();
        mParam1 = param1;
        return fragment;
    }
